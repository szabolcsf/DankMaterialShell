            ...
            Item {
                ...
                readonly property bool hasActivePopout: {
                    const loaders = [{
                                        ...
                                        "loader": tempHistoryPopoutLoader,
                                        "prop": "shouldBeVisible"
                                    }, {
                            ...
                            Item {
                                ...
                                Component {
                                    ...
                                    CpuTemperature {
                                        ...
                                        section: topBarContent.getWidgetSection(parent) || "right"
                                        popoutTarget: {
                                            tempHistoryPopoutLoader.active = true
                                            return tempHistoryPopoutLoader.item
                                        }
                                        parentScreen: barWindow.screen
                                        widgetData: parent.widgetData
                                        toggleTempHistory: (mode) => {
                                                               tempHistoryPopoutLoader.active = true
                                                               return tempHistoryPopoutLoader.item?.toggle(mode)
                                                           }
                                    }
                                }
